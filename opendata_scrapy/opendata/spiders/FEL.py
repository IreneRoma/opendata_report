...
class QuotesSpider(scrapy.Spider):
        ...
        def start_requests(self):
            sf = False
            url= 'http://opendata.santfeliu.cat/santfeliu/es/catalog'
        ...
        def parse(self,response):
                ...
                if self.a is True : 
                    pages = response.xpath('//*[@class="pagination"]//text()').extract()
                ...
                if not self.sf:
                    ...
                    for l in links:
                        link_complteted = "http://opendata.santfeliu.cat" + l
                        self.links_next.append(link_complteted)

                    next_page = 'http://opendata.santfeliu.cat/santfeliu/es/catalog/' + str(self.j)
                    print next_page

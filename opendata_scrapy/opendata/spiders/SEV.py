...
class QuotesSpider(scrapy.Spider):
        ...
        def start_requests(self):
            sf = False
            url= 'http://datosabiertos.sevilla.org/data/'
        ...
        def parse(self,response):
                ...
                if not self.sf:
                    ...
                    #print numeration
                    next_page = 'http://datosabiertos.sevilla.org/data/?offset=' + str(numeration) + '&limit=10'
                ...
                if self.sf:
                    ...
                    item['description'] = response.xpath('//*[@class = "text"]/p/text()').extract_first(default="not-found")

...
class QuotesSpider(scrapy.Spider):
        ...
        def start_requests(self):
            sf = False
            url= 'http://opendata.manresa.cat/dataset'
        ...
        def parse(self,response):
                ...
                if not self.sf:
                    ...
                    for l in links:
                        link_complteted = 'http://opendata.manresa.cat' + l
                        self.links_next.append(link_complteted)

                    next_page = 'http://opendata.manresa.cat/dataset?page=' + str(self.j)

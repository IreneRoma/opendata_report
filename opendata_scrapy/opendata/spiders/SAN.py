...
class QuotesSpider(scrapy.Spider):
        ...
        def start_requests(self):
            sf = False
            url= 'http://datos.santander.es/data/'
        ...
        def parse(self,response):
                ...
                if not self.sf:
                    ...
                    numeration = (self.j -1)*15
                    #print numeration
                    next_page = 'http://datos.santander.es/data/?offset=' + str(numeration) + '&limit=15'
                ...
                if self.sf:
                    ...
                    desc_metadata = response.xpath('//*[@id="content"]/section/div/div/div[2]/div[2]//text()').extract()                    
